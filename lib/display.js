...
function Display(config) {
  ...
  function getPacket(d) {
    // create the buffer
    var buf = new Buffer(5*2 + d.data.length)
      , offset = 0
      , numbers = [d.cmd, d.x, d.y, d.w, d.h];
      ;

    // encode the numbers and write them into buf
    for (i in numbers) {
      x = Number(numbers[i]);
...
exports.moduleWidth = 8;
exports.moduleHeight = 12;
exports.lines = 20;
exports.linelen = 56;
